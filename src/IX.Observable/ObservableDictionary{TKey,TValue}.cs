...
namespace IX.Observable
{
        ...
        IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        public ObservableDictionary(
            ...
            : base(
                new DictionaryCollectionAdapter<TKey, TValue>(
                    new Dictionary<TKey, TValue>(
                        capacity,
                        equalityComparer)), suppressUndoable)
        {
        }
                        ...
                        out TValue val))
                    {
                        ...
                        this.PushUndoLevel(
                            new DictionaryChangeUndoLevel<TKey, TValue>
                                { Key = key, OldValue = val, NewValue = value });
                    }
                    else
                    {
                        // Add the new item
        ...
        protected override void InterpretBlockStateChangesOutsideLock(
            ...
            object[] states) => this.BroadcastChange();
